...
//                                $project = $department->getDepProjectById($departmentId);
                        ...
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-outline-primary" href="index.php?controller=department&action=details&id=<?php echo $dept['id']; ?>"><i class="fa fa-sign-in" aria-hidden="true"></i>&nbsp;&nbsp;i</a>
                                <a class="btn btn-outline-danger" href="index.php?controller=department&action=delete&id=<?php echo $dept['id'] ?>"><i class="fa fa-trash-o" aria-hidden="true"></i>&nbsp;&nbsp;Delete</a> </td>
                            </td>
                        </tr>
