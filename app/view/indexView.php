        ...
        <div class="row">
            <div class="col-md-6">
                <div class="mt-5 mb-3 clearfix">
                    ...
                    <button onclick="location.href = 'index.php?controller=department&action=showNew'"
                ...
                <table class="table table-bordered table-striped">
                    ...
                    foreach ($receivedData["departments"] as $dept) { ?>
                        ...
                        <tr>
                            ...
                            <td><?php echo $receivedData['depId_count'][$dept['id']] ?></td>
                            ...
                            <td>
                                <button class="btn btn-outline-primary" onclick="location.href =
                                    ...
                                    <i class="fa fa-sign-in" aria-hidden="true"></i>&nbsp;&nbsp;Info
                                </button>
            ...
            <div class="col-md-6">
                <div class="mt-5 mb-3 clearfix">
                    ...
                    <button onclick="location.href = 'index.php?controller=programmer&action=showNew'"
                            class="btn btn-success pull-right"><i
                                class="fa fa-plus"></i> Add New Coder
                    </button>
                ...
                <table class="table table-bordered table-striped">
                    ...
                    foreach ($receivedData["progers"] as $proger) { ?>
                        ...
                        <tr>
                            ...
                            <td><?php echo '+373 ' . $proger['phone'] ?></td>
                            ...
                            <td>
                                ...
                                <button class="btn btn-outline-danger"
                                        onclick="location.href = 'index.php?controller=programmer&action=delete&id=<?php echo $proger['id']; ?>'">
                                    <i class="fa fa-trash-o" aria-hidden="true"></i>Delete
                                </button>
